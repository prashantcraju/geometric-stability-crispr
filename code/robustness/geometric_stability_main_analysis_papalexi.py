#!/usr/bin/env python3
"""
Shesha Crispr Analysis — Papalexi 2021 only

Copy of geometric_stability_main_analysis.py with all datasets except
Papalexi 2021 commented out for focused debugging/runs.
"""
...
MANUAL_CONTROLS = {
    # 'Adamson 2016 UPR (CRISPRi)': list(cfg.MANUAL_CONTROLS.get('Adamson 2016 UPR (CRISPRi)', ['gal4','gfp','neg','scramble','unperturbed','nan','control','nt','63(mod)','62(mod)','(mod)'])),
    # 'Dixit 2016 (CRISPR-KO)': ['nan', 'control', 'neg', 'intergenic'],
    'Papalexi 2021 (CRISPR-KO)': ['nt', 'non-targeting', 'control'],
}
